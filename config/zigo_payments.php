...
return ['default'=>'mercado_pago','platform'=>[
 ...
 'oauth_test_token'=>env('ZIGO_MP_OAUTH_TEST_TOKEN',env('ZIGO_MP_ENVIRONMENT','sandbox')==='sandbox'),
 'use_sandbox_init_point'=>env('ZIGO_MP_USE_SANDBOX_INIT_POINT',env('ZIGO_MP_ENVIRONMENT','sandbox')==='sandbox'),
