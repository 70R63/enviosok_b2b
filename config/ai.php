...
return [
    ...
    'cost_guard' => ['global_monthly_budget_usd' => env('AI_PROVIDER_GLOBAL_MONTHLY_BUDGET_USD', null), 'alert_thresholds' => [0.70, 0.85, 0.95, 1.00]],
    'billing' => ['grace_days' => (int) env('AI_BILLING_GRACE_DAYS', 3)],
