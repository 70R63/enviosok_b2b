...
<div class="topbar">
    <div class="brand">ZIGO Soporte</div>
...
<div class="container">
    ...
    <div class="header">
        <div>
            ...
            <div class="subtitle">
                Mesa de ayuda y seguimiento operativo
            </div>
        </div>
    </div>
    ...
    <div class="card">
       ...
       <form method="GET" style="display:flex;gap:12px;margin-bottom:24px;">
            ...
            <a href="{{ route('soporte.incidencias.index') }}" class="btn" style="background:#64748b;">
                Limpiar
            </a>
        </form>
            ...
            @forelse($incidencias as $incidencia)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a
                            href="{{ route('soporte.incidencias.show',$incidencia->id) }}"
                            class="btn">
