...
@section('content')
<div class="z-cluster z-cluster--between"><div><div class="eyebrow">ZIGO AI</div><h1>Conocimiento</h1><p>Administra información aprobada para tus agentes.</p></div><a class="z-btn" href="{{ route('tenant.admin.ai-knowledge.create') }}">Crear fuente</a></div>
