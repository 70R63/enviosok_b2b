...
@if($connection?->isConnected())<span class="z-badge z-badge--success">Conectado ✓</span><dl><dt>Cuenta</dt><dd>{{ $connection->provider_account_id ?: 'Identificador protegido' }}</dd><dt>Conectado</dt><dd>{{ $connection->connected_at?->format('d/m/Y H:i') }}</dd></dl>
