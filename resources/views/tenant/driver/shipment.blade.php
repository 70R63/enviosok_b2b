...
@endif
@php($next=['READY_FOR_PICKUP'=>['PICKED_UP'=>'Paquete recolectado'],'PICKED_UP'=>['IN_TRANSIT'=>'Iniciar traslado'],'IN_TRANSIT'=>['OUT_FOR_DELIVERY'=>'Salir a entrega'],'OUT_FOR_DELIVERY'=>['DELIVERED'=>'Confirmar entrega','DELIVERY_FAILED'=>'Reportar entrega fallida']][$shipment->status]??[])
