...
<div class="layout">
    ...
    <main class="content">
        ...
        <div class="grid">
            <div class="card"><div class="label">Usuarios B2C</div><div class="value">0</div></div>
            <div class="card"><div class="label">Empresas</div><div class="value">0</div></div>
            <div class="card"><div class="label">Incidencias</div><div class="value">0</div></div>
