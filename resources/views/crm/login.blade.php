...
<head>
    ...
    <style>
        ...
        .brand{background:#111827;color:white;padding:60px 45px;display:flex;flex-direction:column;justify-content:center}
...
<div class="box">
    <div class="brand">
        <h1>CRM ZIGO</h1>
        <p>Centro de control administrativo para usuarios, empresas, guías, incidencias, pagos, adeudos y operación general.</p>
    ...
    <div class="form">
        ...
        <form method="POST" action="{{ route('crm.login.post') }}">
            ...
            <button class="btn" type="submit">Ingresar al CRM</button>
        </form>
    </div>
</div>
