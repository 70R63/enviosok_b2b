...
<head>
    ...
    <style>
        ...
        .brand{background:#4338ca;color:white;padding:60px 45px;display:flex;flex-direction:column;justify-content:center}
...
<div class="box">
    <div class="brand">
        <h1>API Hub ZIGO</h1>
        <p>Portal para integradores, consumo de APIs, credenciales, documentación, webhooks y facturación técnica.</p>
        <p><strong>Acceso para clientes API autorizados.</strong></p>
    </div>
    ...
    <div class="form">
        ...
        <form method="POST" action="{{ route('hub.login.post') }}">
            @csrf
            ...
            <button class="btn" type="submit">Ingresar al API Hub</button>
        </form>
    </div>
</div>
