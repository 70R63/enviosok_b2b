...
final class CrmGuideRecoveryController extends Controller
{
    ...
    public function pdf(B2cCotizacion $cotizacion,XpertaGuidePdfService $pdf,GuideRecoveryService $recovery){ if(!$cotizacion->guia_id&&!$cotizacion->tracking_number)abort(409);$result=$pdf->fetch($cotizacion);$recovery->audit($result,'FETCH_PDF','SUCCESS');return back()->with('success','PDF recuperado.'); }
