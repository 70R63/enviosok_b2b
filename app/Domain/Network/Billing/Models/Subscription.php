...
final class Subscription extends Model
{
 ...
 protected $table='network_subscriptions';protected $fillable=['tenant_id','plan_id','status','operations_limit','started_at','current_period_start','current_period_end','trial_ends_at','grace_ends_at','canceled_at','ended_at','provider_subscription_id','provider_plan_id','provider_status','next_payment_date','billing_frequency','cancel_at_period_end'];
 protected $casts=['operations_limit'=>'integer','started_at'=>'datetime','current_period_start'=>'datetime','current_period_end'=>'datetime','trial_ends_at'=>'datetime','grace_ends_at'=>'datetime','canceled_at'=>'datetime','ended_at'=>'datetime','next_payment_date'=>'datetime','cancel_at_period_end'=>'boolean'];
