...
final class TenantCustomerCheckout extends Model
{
    ...
    protected $fillable = ['tenant_id', 'customer_profile_id', 'tenant_operation_id', 'status', 'payment_status', 'currency', 'shipping_amount', 'evidence_amount', 'total_amount', 'quote_snapshot', 'shipping_data_snapshot', 'proof_option_snapshot', 'payment_provider', 'payment_reference', 'expires_at', 'paid_at'];
    protected $casts = ['quote_snapshot' => 'array', 'shipping_data_snapshot' => 'array', 'proof_option_snapshot' => 'array', 'shipping_amount' => 'decimal:2', 'evidence_amount' => 'decimal:2', 'total_amount' => 'decimal:2', 'expires_at' => 'datetime', 'paid_at' => 'datetime'];
