...
class ZigoNetworkOperationsConsoleTest extends ZigoNetworkOnboardingOperationsTest
{
 ...
 public function test_pre_stage_network_navigation_smoke_has_no_dead_or_duplicate_links():void
 {
  ...
  $layout=file_get_contents(resource_path('views/network/layout.blade.php'));$this->assertSame(1,substr_count($layout,'>Launchpad</a>'));$this->assertSame(1,substr_count($layout,'>Mapa Network</a>'));$this->assertSame(2,substr_count($layout,'>Dashboard</a>'));$this->assertSame(1,substr_count($layout,'>Onboarding</a>'));$this->assertStringNotContainsString('>Consumo</a>',$layout);$dashboard=file_get_contents(resource_path('views/network/dashboard.blade.php'));$this->assertSame(0,substr_count($dashboard,'>Launchpad</a>'));$this->assertSame(0,substr_count($dashboard,'>Mapa Network</a>'));
