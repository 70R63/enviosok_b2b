...
use App\Domain\Network\Billing\Models\{Entitlement, Subscription, UsageEvent};
...
use App\Models\User;
use App\Services\{ZigoCommercialQuoteService, ZigoProviderRateService};
...
final class NetworkTenantB2cTest extends TestCase
{
    ...
    private function quote(): array { return ['cp_origen' => '64000', 'cp_destino' => '64000', 'tipo_envio' => 'sobre', 'peso' => 1]; }
    private function url(Tenant $tenant, string $path): string { return 'http://' . $tenant->primaryDomain()->first()->domain . $path; }
